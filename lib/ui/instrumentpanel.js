...
/*
 direction = 1 => goto next page
 direction != 1 => goto previous page
 The notification page is skipped if notificationLevel < 2 (alert)
*/
InstrumentPanel.prototype.gotoNextPrevPage = function(direction) {
    var nextPage = (this.currentPage + direction) % this.pages.length;
    if (this.currentPage === notificationPageId) {
      nextPage = (direction === 1) ? 0 : this.pages.length -1;
    } else if (
          (this.currentPage === this.pages.length -1) &&
          (direction === 1) && (this.notificationLevel > 1)) {
        nextPage = notificationPageId;
      }
