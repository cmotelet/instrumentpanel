...
import {
  ...
  darkModeSetByOs,
  darkModeSetBySkPath
} from './settings/darkmodesettings';
...
InstrumentPanel.prototype.getDarkMode = function getDarkMode() {
  return (this.darkMode.darkModeCurrent === darkModeDark);
}

InstrumentPanel.prototype.getDarkModeValue = function getDarkMode() {
  return this.darkMode.darkModeCurrent;
}

InstrumentPanel.prototype.setDarkMode = function setDarkMode(darkMode) {
  this.colorScheme.scheme = (darkMode) ? darkModeDark : darkModeLight;
  this.darkMode.darkModeCurrent = this.colorScheme.scheme;
}

InstrumentPanel.prototype.setDarkModeSetByMainbar = function setDarkModeSetByMainbar() {
  this.darkMode.darkModeSetBy = darkModeSetByMainbar;
}

InstrumentPanel.prototype.setDarkModeSetBy = function setDarkModeSetByMainbar(darkModeSetBy) {
  this.darkMode.darkModeSetBy = darkModeSetBy;
}

InstrumentPanel.prototype.isDarkModeByOs = function isDarkModeByOs() {
  return (this.darkMode.darkModeSetBy === darkModeSetByOs);
}

InstrumentPanel.prototype.isDarkModeSetBySkPath = function isDarkModeSetBySkPath() {
  return (this.darkMode.darkModeSetBy === darkModeSetBySkPath);
}
